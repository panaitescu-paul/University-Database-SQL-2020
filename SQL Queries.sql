...
name CHAR(50), main_office CHAR(50), phone CHAR(12),
dean CHAR(50), PRIMARY KEY (name)
); 

-- ------------------------------------------------ 
USE University;
CREATE TABLE Department (
name CHAR(50), code_number INT(11),
main_office CHAR(50), phone CHAR(50),
chairman CHAR(50), chairman_start_date DATE, PRIMARY KEY (code_number)
); 
...
CREATE TABLE Course (
name CHAR(50), code_number INT(11),
level INT(1), credit_hours INT(5), description CHAR(100),
...
id INT, building_code INT,
room_number INT,
PRIMARY KEY (id) );

-- ------------------------------------------------
USE University; CREATE TABLE Section (
id INT,
course_code INT,
instructor_id INT,
number INT,
...
days_times CHAR(50),
PRIMARY KEY (id),
FOREIGN KEY (course_code) REFERENCES Course(code_number), FOREIGN KEY (instructor_id) REFERENCES Instructor(id), FOREIGN KEY (classroom_id) REFERENCES Classroom(id)
); 

-- ------------------------------------------------ 
USE University;
CREATE TABLE College_Department (
college_name CHAR(50), department_code INT,
FOREIGN KEY (college_name) REFERENCES College(name),
FOREIGN KEY (department_code) REFERENCES Department(code_number) );

-- ------------------------------------------------
USE University; CREATE TABLE Level (
id INT,
level_name CHAR(10),
PRIMARY KEY (id) );
...
ALTER TABLE Course
ADD CONSTRAINT course_ibfk_1 FOREIGN
REFERENCES level (id) ON UPDATE CASCADE
ON DELETE SET NULL;
...
REFERENCES Department (code_number) ON UPDATE CASCADE
ON DELETE SET NULL;
...
ALTER TABLE Section
ADD CONSTRAINT section_ibfk_1 FOREIGN
REFERENCES Course (code_number) ON UPDATE CASCADE
ON DELETE SET NULL;
...
ALTER TABLE Section
ADD CONSTRAINT section_ibfk_2 FOREIGN
...
ALTER TABLE Section
ADD CONSTRAINT section_ibfk_3 FOREIGN
REFERENCES Classroom (id) ON UPDATE CASCADE
ON DELETE SET NULL;
...
REFERENCES College (name) ON UPDATE CASCADE
ON DELETE SET NULL;
...
GRANT SELECT ON *.* TO 'constantin1'@'%' WITH GRANT OPTION; GRANT UPDATE, DELETE ON *.* TO 'marius1'@'%' WITH GRANT OPTION; 

-- -----------------------------------------------
SHOW GRANTS for 'paul1'@'%';
SHOW GRANTS for 'constantin1'@'%';
SHOW GRANTS for 'marius1'@'%'; SELECT * FROM mysql.user;
...
INSERT INTO Course (name, code_number, level, credit_hours, description) VALUES ('Testing', '1235', '4', '15', 'description 2'); INSERT INTO Course (name, code_number, level, credit_hours, description) VALUES ('Microservices', '1236', '4', '10', 'description 3');
